...
class UserApiTest extends TestCase
{
    ...
    {
        $profile = MixinSDK::user()->readProfile();
    ...
    public function test_it_can_update_now_user_profile_and_avatar_success0()
    {
        ...
        $profile   = MixinSDK::user()->updateProfile($full_name);
        ...
        $profile       = MixinSDK::user()->updateProfile($full_name, $avatar_base64);
        self::assertEquals($full_name, $profile['full_name']);
    ...
    public function test_it_can_update_now_user_proferences_success0()
    {
        ...
        $profile                     = MixinSDK::user()->updatePreferences('EVERYBODY', 'EVERYBODY');
        ...
        $profile                     = MixinSDK::user()->updatePreferences('CONTACTS', 'CONTACTS');
        ...
        MixinSDK::user()->updatePreferences($receive_message_source0, $accept_conversation_source0);
    ...
    {
        $profile0 = MixinSDK::user()->rotateQRCode();
        $profile1 = MixinSDK::user()->rotateQRCode();
    ...
    {
        $profile = MixinSDK::user()->readFriends();
