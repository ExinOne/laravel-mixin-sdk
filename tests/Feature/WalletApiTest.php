...
class WalletApiTest extends TestCase
{
    public function test_it_can_create_address_success0()
    {
        ...
        $label     = 'mixinSDK';
        $pin       = MixinSDK::getConfig('default')['pin'];

        $res = MixinSDK::wallet()->createAddress($assetId, $publicKey, $pin, $label);
        dump($res);
        ...
        $res = MixinSDK::wallet()->createAddress($assetId, $publicKey, $pin, $account_name, true);
        dump($res);
        self::assertInternalType('array', $res);
    ...
    public function test_it_can_read_addresses_success0()
    {
        ...
        $res     = MixinSDK::wallet()->readAddresses($assetId);
        dump($res);
        self::assertInternalType('array', $res);
    ...
    public function test_it_can_read_address_success0()
    {
        ...
        $res       = MixinSDK::wallet()->readAddress($addressId);
        self::assertInternalType('array', $res);
    ...
    public function test_it_can_delete_address_success0()
    {
        ...
        $pin       = MixinSDK::getConfig('default')['pin'];
        $res       = MixinSDK::wallet()->deleteAddress($addressId, $pin);
        self::assertEmpty($res);
    }

    public function test_it_can_read_user_assets_success0()
    {
        $assets = MixinSDK::wallet()->readAssets();
        dump($assets);
    ...
    {
        $assetId = 'c6d0c728-2624-429b-8e0d-d9d19b6592fa';
        $assets  = MixinSDK::wallet()->readAsset($assetId);
        self::assertInternalType('array', $assets);
    }
    ...
    {
        $assetId = 'c6d0c728-2624-429b-8e0d-d9d19b6592fa';
        $assets  = MixinSDK::wallet()->deposit($assetId);
        dump($assets);
        self::assertInternalType('array', $assets);
    }
    ...
    public function test_it_can_withdrawal_success0()
    {
        ...
        $res = MixinSDK::wallet()->withdrawal($addressId, $amount, $memo, $pin);
        dump($res);
        self::assertInternalType('array', $res);
    }
    ...
    public function test_it_can_transfer_success0()
    {
        ...
        $res = MixinSDK::wallet()->transfer($asset_id, $opponent_id, $pin, $amount, $memo);
        dump($res);
        self::assertInternalType('array', $res);
    }
    ...
    public function test_it_can_verify_payment_success0()
    {
        ...
        $res = MixinSDK::wallet()->verifyPayment($asset_id, $opponent_id, $amount, $trace_id);
        dump($res);
        self::assertInternalType('array', $res);
    }
    ...
    public function test_it_can_read_transfer_success0()
    {
        ...
        $res = MixinSDK::wallet()->readTransfer($trace_id);
        dump($res);
        self::assertInternalType('array', $res);
    }
    ...
    public function test_it_can_read_asset_fee_success0()
    {
        ...
        $res = MixinSDK::wallet()->readAssetFee($asset_id);
        dump($res);
        self::assertInternalType('array', $res);
    }
    ...
    public function test_it_can_read_user_snapshots_success0()
    {
        ...
        $networkInfo0 = MixinSDK::wallet()->readUserSnapshots($limit);
        dump($networkInfo0);
        self::assertInternalType('array', $networkInfo0);
        self::assertCount(2, $networkInfo0);

        $networkInfo1 = MixinSDK::wallet()->readUserSnapshots($limit, $offset);
        dump($networkInfo1);
        self::assertInternalType('array', $networkInfo1);
        self::assertCount(2, $networkInfo1);

        $networkInfo2 = MixinSDK::wallet()->readUserSnapshots($limit, $offset, $assetId);
        dump($networkInfo2);
        ...
        $networkInfo3 = MixinSDK::wallet()->readUserSnapshots($limit, $offset, $assetId, $order);
        dump($networkInfo3);
        ...
        $networkInfo4 = MixinSDK::wallet()->readUserSnapshots($limit, null, $assetId, $order);
        dump($networkInfo4);
        ...
        $networkInfo5 = MixinSDK::wallet()->readUserSnapshots(null, $offset, $assetId);
        dump($networkInfo5);
    ...
    public function test_it_can_read_user_snapshot_success0()
    {
        ...
        $res = MixinSDK::wallet()->readUserSnapshot($snapshot_id);
        dump($res);
        self::assertInternalType('array', $res);
    }
}
